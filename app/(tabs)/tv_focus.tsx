  ...
  return (
    ...
    >
      ...
      <Collapsible title="How it works">
        ...
        <ThemedText>
          On web, the tab key can be used to focus the buttons and show the same
          events. Also on web, this demo logs hover events "onHoverIn()" and
          "onHoverOut()" when the mouse pointer passes over the demo Pressable
          buttons.
        </ThemedText>
      </Collapsible>
